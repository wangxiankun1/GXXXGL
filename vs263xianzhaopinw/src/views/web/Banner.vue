<template>
    <div class="big-box">
      <div class="img-box">
        ...
        >
          <img src="../../assets/daohang/daohang3.jpg" alt="" />
          <img v-for="item in src" :key="item" :src="item.img" alt="" />
          <img src="../../assets/daohang/daohang1.jpg" alt="" />
        </div>
      </div>
      <div class="arrowhead-box" ref="swiper">
        <span @click="last"><img src="../../assets/daohang/left.jpeg" alt="" style="height:50px ;width:50px"></span>
        <span @click="next"><img src="../../assets/daohang/left.jpeg" alt="" style="height:50px ;width:50px"></span>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        src: [
          { img: require("../../assets/daohang/daohang1.jpg") },
          { img: require("../../assets/daohang/daohang2.jpg") },
          { img: require("../../assets/daohang/daohang3.jpg") },
        ],
        translateX: 0,
        tsion: true,
      };
