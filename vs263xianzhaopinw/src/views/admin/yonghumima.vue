      ...
      <div class="login-container">
        ...
        >
          ...
          <el-form-item prop="checkPass">
            <el-input
              type="password"
              v-model="loginMode.yonghuPassword1"
              auto-complete="off"
              placeholder="新密码"
            ></el-input>
          </el-form-item>
          <el-form-item prop="checkPass">
            <el-input
              type="password"
              v-model="loginMode.yonghuPassword2"
              auto-complete="off"
              placeholder="新密码"
            ></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {  
    ...
    login() {
      ...
      let yonghuPassword1 = this.loginMode.yonghuPassword1;
      let yonghuPassword2 = this.loginMode.yonghuPassword2;
      ...
      if (yonghuPassword1 != yonghuPassword2) {
        this.$message({
          message: "两次输入密码不一致",
          type: "error",
          offset: 320,
        ...
        let url = base + "/mimaYonghu?yonghuId="+this.yonghuId;
        this.loading = true;
