      ...
      <div class="login-container">
        ...
        >
          ...
          <el-form-item prop="checkPass">
            <el-input
              type="password"
              v-model="loginMode.userPassword1"
              auto-complete="off"
              placeholder="新密码"
            ></el-input>
          </el-form-item>
          <el-form-item prop="checkPass">
            <el-input
              type="password"
              v-model="loginMode.userPassword2"
              auto-complete="off"
              placeholder="新密码"
            ></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {  
    ...
    login() {
      ...
      let userPassword1 = this.loginMode.userPassword1;
      let userPassword2 = this.loginMode.userPassword2;
      ...
      if (userPassword1 != userPassword2) {
        ...
        let url = base + "/mimaUser?userId="+this.userId;
        this.loading = true;
