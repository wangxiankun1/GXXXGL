<template>
  <section style="margin: 10px">
    ...
    <el-table ref="exportTableRef" @selection-change="handleSelectionChange" id="myTable" :data="datalist" border stripe v-loading="listLoading" highlight-current-row max-height="800" size="small" style="width: 100%">
      ...
      <!--合同下载开始-->
      <el-table-column prop="uxinxiImgName" align="center" label="合同" width="50">
    ...
    <el-dialog :title=jcpeizhi.uxinxiBieming v-model="formVisible" width="40%" :close-on-click-modal="false">
      <el-form :model="formData" ref="formDataRef" :rules="rules" label-width="100px">
        ...
        <el-form-item label="合同" prop="uxinxiImg">
    ...
    <!--导入上传结束-->
    <!--上传表单-->
    <el-dialog v-model="uploadVisible" title="合同上传" custom-class="el-dialog-widthSmall">
      <div>
        <b>请选择文件进行上传！&emsp;</b>
      </div>
      <el-upload
